		...
		function adapArchitectureCustomMethods(pos){
			...
			methods[0]=function(){
				...
				switch (select.value) {
					...
					case "Ad-Hoc":
						graph.removeCellOverlay(graph.getModel().getCell(this.name));
						overlayRigth = new mxCellOverlay(new mxImage('images/models/adap_architecture/icons/ad-hoc.png', 16, 16), 'Overlay tooltip');
						break;
					default:
					...
					//borde acomodable
					let overlayFrame = new mxCellOverlay(new mxImage('images/models/adap_architecture/icons/module-frame.png', 16, 16), 'Overlay tooltip');
			...
			methods[1]=function(){
				...
				switch (select.value) {
					...
					case "Local Computer":
						graph.removeCellOverlay(graph.getModel().getCell(this.name));
						overlayRigth = new mxCellOverlay(new mxImage('images/models/adap_architecture/icons/local_computer.png', 16, 16), 'Overlay tooltip');
						break;
					case "Firmware":
						console.log("pase");
						graph.removeCellOverlay(graph.getModel().getCell(this.name));
			...
			methods[2]=function(){
				...
				switch (selectOption) {
					...
					case "AppWeb":
						graph.removeCellOverlay(graph.getModel().getCell(this.name));
						overlayRigth = new mxCellOverlay(new mxImage('images/models/adap_architecture/icons/App Web.png', 16, 16), 'Overlay tooltip');
						break;
					case "AppMovil":
						graph.removeCellOverlay(graph.getModel().getCell(this.name));
						overlayRigth = new mxCellOverlay(new mxImage('images/models/adap_architecture/icons/App movil.png', 16, 16), 'Overlay tooltip');
						break;
					case "AppStandalone":
						graph.removeCellOverlay(graph.getModel().getCell(this.name));
						overlayRigth = new mxCellOverlay(new mxImage('images/models/adap_architecture/icons/App Standalone.png', 16, 16), 'Overlay tooltip');
						break;
					case "Embedded":
						graph.removeCellOverlay(graph.getModel().getCell(this.name));
					...
					case "APPI":
						graph.removeCellOverlay(graph.getModel().getCell(this.name));
						overlayRigth = new mxCellOverlay(new mxImage('images/models/adap_architecture/icons/Appi app.png', 16, 16), 'Overlay tooltip');
						break;
					case "Services":
						graph.removeCellOverlay(graph.getModel().getCell(this.name));
						overlayRigth = new mxCellOverlay(new mxImage('images/models/adap_architecture/icons/Web services.png', 16, 16), 'Overlay tooltip');
						break;
					default:
						overlayRigth = new mxCellOverlay(new mxImage('images/MX/check.png', 16, 16), 'Overlay tooltip');	
						break;
