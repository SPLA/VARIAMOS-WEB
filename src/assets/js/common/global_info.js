...
export function getModelInfo(){
    ...
    info["gmodels"] = ["feature", "component", "binding_feature_component", "istar" , "adap_architecture", "dinamic_adap_architecture",
    ...
    //define adapt_architecture model main info
    info["dinamic_adap_architecture"]={projFolders:["Domain"], label:"Dinamic Adaptative Architecture"};
